  ...
  return (
    <section className="w-[100%] relative  h-[100vh]">
      ...
      <div className="absolute top-0 bottom-0 right-0 left-0 z-[5] flex justify-center items-center flex-col gap-16">
        ...
        <div className="md:w-3/5 w-[95%] border-2 bg-white mx-auto rounded-3xl   text-black flex md:flex-row flex-col md:justify-around gap-6 md:gap-0 py-20 md:py-0  items-center absolute bottom-0 right-0 left-0 z-[5]">
